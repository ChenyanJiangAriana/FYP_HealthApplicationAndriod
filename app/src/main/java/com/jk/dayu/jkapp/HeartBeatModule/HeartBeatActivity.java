...
public class HeartBeatActivity extends BaseActivity {
    ...
    private void initConfig() {
        ...
        mTV_Heart_Rate = findViewById(R.id.id_tv_heart_rate);
        mTV_Heart_Test = findViewById(R.id.id_tv_test);
        mTV_Avg_Pixel_Values = findViewById(R.id.id_tv_Avg_Pixel_Values);
        mTV_pulse = findViewById(R.id.id_tv_pulse);
