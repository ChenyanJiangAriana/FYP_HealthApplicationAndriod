package com.jk.dayu.jkapp.stepModule.step;
...
import com.jk.dayu.jkapp.stepModule.MyApplication;
...
public class StepService extends Service {
    ...
    public void myStartForeground() {
        ...
        stackBuilder.addParentStack(StepActivity.class);
    ...
    public void onDestroy() {
        ...
        if (temp) {
            ...
            Intent intent = new Intent("com.jk.dayu.jkapp.start");
